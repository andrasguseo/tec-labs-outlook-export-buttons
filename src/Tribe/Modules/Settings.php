...
class Settings {
	...
	public function add_settings() {
		$fields = [
			...
			'a_setting' => [ // TODO
				'type'            => 'text',
				'label'           => esc_html__( 'xxx try this', 'tec-labs-outlook-export-buttons' ),
				'tooltip'         => sprintf( esc_html__( 'Enter your custom URL, including "http://" or "https://", for example %s.', 'tec-labs-outlook-export-buttons' ), '<code>https://wpshindig.com/events/</code>' ),
	...
	private function get_example_intro_text() {
		$result = '<h3>' . esc_html_x( 'Example Extension Setup', 'Settings header', 'tec-labs-outlook-export-buttons' ) . '</h3>';
		$result .= '<div style="margin-left: 20px;">';
		$result .= '<p>';
		$result .= esc_html_x( 'Some text here about this settings section.', 'Settings', 'tec-labs-outlook-export-buttons' );
		$result .= '</p>';
		$result .= '</div>';
